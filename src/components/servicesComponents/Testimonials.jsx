...
export default function Testimonials() {
  const reviews = [
    { name: "LogiTech Inc.", feedback: "TranstechWorld boosted our logistics efficiency by 40%. Outstanding!" },
  ...
  return (
    <section className="py-20 bg-black text-white text-center">
      <h2 className="text-3xl font-bold mb-12">What Clients Say About TranstechWorld</h2>
